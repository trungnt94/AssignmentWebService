...
public class UsersJerseyClient {
    ...
    public UsersJerseyClient() {
        ...
        webTarget = client.target(BASE_URI).path("entity.users");
    }
    ...
    public <T> T find_XML(Class<T> responseType, String username) throws ClientErrorException {
        WebTarget resource = webTarget;
    ...
    public void create_JSON(Object requestEntity) throws ClientErrorException {
     ...
     public <T> T findUsername(Class<T> responseType, String username) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.queryParam("username", username);
        resource = resource.path("findUser");
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }
     
     public <T> T findById(Class<T> responseType, Integer id) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.queryParam("id", id);
        resource = resource.path("findById");
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }
